...
<div class="header header-sticky">
	<div class="container">
		<!-- Logo -->
		<a class="logo" href="${pageContext.request.contextPath}/views/main.jsp"> <img src="${pageContext.request.contextPath}/resources/img/icon/trollface/trollface-152-236195.png" style="width:40px; height: 40px;" alt="Logo"></a>
		<!-- End Logo -->
