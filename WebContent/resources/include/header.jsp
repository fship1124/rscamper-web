...
<!-- 알림 팝오버 -->
<div class="last-noti-list mynotice dropdown-menu" role="menu" aria-labelledby="dLabel"><div class="noti-tri"></div>
...
<div class="see-all-notice">더 보기</div></div>
...
<!-- 				<li style="margin-right: 20px; cursor: pointer;"><img src="/rscamper-web/resources/img/default/icon-new-bell.png"><span class="noti-count" style="color: #ff8000; line-height: 19px;">0</span></li> -->
				<li data-placement="bottom" data-toggle="popover" data-container="body" data-placement="left" data-html="true"
					style="margin-right: 20px; cursor: pointer;" ><i class="fa fa-bell"></i> 
					<span class="noti-count" style="color: #ff8000; line-height: 19px;">0</span>
				</li>
