		...
		<div class="breadcrumbs">
			<div class="container">
				<ul class="breadcrumb pull-left">
					...
					<li><a href="javascript:history.back()">관광지</a></li>
				</ul>
			</div>
		</div>
		...
		<div class="container content-md" style="padding: 0px; margin-top: 10px;">
			<div class="row">
				<section class="col-lg-12">
					<button class="btn-u rounded" type="button" value="A01" onclick="typeChange(this)"><i class="fa fa-bookmark-o"></i> 자연</button>
					<button class="btn-u btn-u-purple rounded" type="button" value="A02" onclick="typeChange(this)"><i class="fa fa-coffee"></i> 인문(문화/예술/역사)</button>
				</section>
			</div>
