	...
	function goDetail(e) {
		...
		var url = myConfig.serverUrl + "/rscamper-web/views/tour-destination/detail.jsp?contentid=" + e.getAttribute("data-value1") + "&contenttypeid=" + e.getAttribute("data-value2");
		$(e).attr('href', url);
	}