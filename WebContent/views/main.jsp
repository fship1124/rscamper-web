...
<body class="header-fixed header-fixed-space-default">
	...
	<br><br>
			<!-- 스케줄관리 -->
			<div class="bigHeader row" style="line-height:37px; font-size: 24px; font-weight: 700; border-bottom:3px solid black; margin: 0;">
                	일정스케줄
<!--             	<div class="content-tabs"></div> -->
			</div>
			
			<div class="row" id="tourPlanList" style='margin: 0;'></div>
...
<!--             	<div class="content-tabs"></div> -->
		   		...
		   		<div class="row" id="benefitList" style='margin: 0;'></div>
		
			<!-- 관광지, 숙소, 맛집-->  
		   <div class="col-md-5">
		   		<h2 class="title-v4" style="margin: 0 0 10px">관광지</h2>
		   		<div id="touristList" style="width:350px; height:850px;"></div>
		   	</div> 
		   	
		   <!-- 맛집 -->            	
		   <div class="col-md-5">
		   		<h2 class="title-v4" style="margin: 0 0 10px;">맛집</h2>
			...
			<!-- 숙소 --> 
             <div class="col-md-5">
		   		<h2 class="title-v4" style="margin: 0 0 10px;">숙소</h2>
