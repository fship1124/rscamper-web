	...
	<div class="wrapper">
		...
		<div class="container content-md" style="padding: 20px;">
			...
			<div class="call-action-v1-in inner-btn page-scroll"
				...
				<a href="portfolio_4_columns_grid_no_space.html"
					class="btn-u btn-brd btn-brd-hover btn-u-dark btn-u-block"
					style="margin-right: 0">+ 방 만들기</a>
			</div>


			<div class="contex-bg" style="margin-top: 50px;">

				<p class="bg-success">
					<label style="width: 300px;">Normal distribution of letters</label><span>Normal
						distribution of letters</span> <span>Normal distribution of
						letters</span><span>Normal distribution of letters</span>
					<button>Go</button>
				</p>
				<p class="bg-info">
					<span>Normal distribution of letters</span><span>Normal
						distribution of letters</span> <span>Normal distribution of
						letters</span><span>Normal distribution of letters</span>
					<button>Go</button>
				</p>
